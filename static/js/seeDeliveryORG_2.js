...
var hudai = (id) =>
{
	...
	if(parseInt(sDate[1])>parseInt(eDate[1])){
		document.getElementById('wrongThisDeliveryCreate').innerHTML = "Ending month cannot be lower than Staring month!";
		$('#myModalWrongDeliveryCreate').modal('show');
	}
	else if(parseInt(sDate[0])>parseInt(eDate[0])){
