...
// const lastSection = document.querySelector(".Quixx__Pricing");
...
//                 firstSection.classList.remove(sticky2Class);
//                 firstSection.classList.add(stickyClass);
//                 thead.style.top = 0;
//                 firstSection.style.paddingTop = `${theadHeight}px`;
//             } else {
//                 firstSection.classList.remove(stickyClass);
//                 firstSection.classList.add(sticky2Class);
//                 thead.style.top = `calc(100% - ${theadHeight}px)`;
//             }
//         } else {
//             firstSection.classList.remove(stickyClass, sticky2Class);
